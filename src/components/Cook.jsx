...
const Cook = () => {
  return (
    <div>
      <div className='w-full h-200 bg-orange-100 flex-col justify-center items-center'>
            <div className='flex gap-105 bg-orange-100'>
                <NavLink to="/khmer"><button className='w-10 h-10 bg-orange-50 text-2xl rounded-full shadow-lg my-8 mx-10 hover:scale-105 transition'><IoMdArrowRoundBack className='mx-2'/></button></NavLink>
                <div className='text-center'>
                <h1 className='text-3xl font-bold py-8 text-orange-900'>Amok Recipe</h1>
                </div>
            </div>
        <div className='w-[90%] h-[80%] flex shadow-2xl bg-orange-50 ml-15'>
            ...
            <div className='w-[50%] h-full '>
                <div className='w-full h-[70%] p-5'>
                 ...
                 '>
                   ...
                   <div className='bg-amber-200 rounded-3xl w-20  h-[95%] shadow-2xl  '>  
                        <div className=' w-full h-[50%]  pt-5  '> <p>250-350</p>

                        </div>
                        <div className=' w-full h-[50%] rounded-2xl  bg-amber-100 py-5 '><p>Calories</p> </div>
                    </div>
                    <div className='bg-amber-200 rounded-3xl w-20  h-[95%]  shadow-2xl  '>  
                        <div className=' w-full h-[50%] '><p className=' text-center pt-5  '>20-25</p> </div>
                        <div className=' w-full h-[50%] rounded-2xl  bg-amber-100 pt-5'><p >Protein</p> </div>
                    </div>
                    <div className='bg-amber-200 rounded-3xl w-20  h-[95%]  shadow-2xl '>  
                        <div className=' w-full h-[50%] pt-5'><p>18-25</p> </div>
                        <div className=' w-full h-[50%] rounded-2xl  bg-amber-100  pt-5'><p>Fat</p> </div>
                    </div>
                    <div className='bg-amber-200 rounded-3xl w-20  h-[95%] shadow-2xl '>  
                        <div className=' w-full h-[50%] pt-5 '><p> 8-12</p> </div>
                        <div className=' w-full h-[50%] rounded-2xl  bg-amber-100  pt-5'><p>Carbs</p> </div>
                    </div>
