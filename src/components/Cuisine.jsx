...
const Cuisine = () => {
  return (
    <div>
        <div className='w-full h-175 bg-linear-to-r from-orange-100 to-orange-200 flex-col justify-center'>
            ...
            <div className='flex flex-wrap gap-10 justify-center'>
                {cuisineData.map(cuisine => (
                    ...
                    <div key={cuisine.id} className='w-40 h-50 bg-linear-to-r from-orange-600 to-orange-500 rounded-xl overflow-hidden shadow-lg hover:scale-110 transition mt-6'>
